...
import ReactNativeLogo from "/icons/ReactNative.svg";
import ExpoLogo from "/icons/Expo.svg";
...
export const dataTools = {
  ...
  angular: {
    title: "Angular",
    caption: "Framework para aplicaciones web robustas",
    logo: { AngularLogo },
    category: 3,
  },
  tailwindcss: {
    title: "Tailwind CSS",
    caption: "Framework CSS para diseño rápido",
    logo: { TailwindCSSLogo },
    category: 3,
  },
  typescript: {
    title: "TypeScript",
    caption: "JavaScript con tipado estático",
    logo: { TSLogo },
    category: 3,
  },

  // BACKEND TOOLS (Category 4)
  springboot: {
    title: "Spring Boot",
    caption: "Framework Java para backend",
    logo: { SpringBootLogo },
    category: 4,
  },
  mongodb: {
    title: "MongoDB",
    caption: "Base de datos NoSQL escalable",
    logo: { MongoDBLogo },
    category: 4,
  },
  mysql: {
  ...
  jwt: {
    title: "JWT",
    caption: "Autenticación segura con tokens",
    logo: { JWTLogo },
    category: 4,
  },
  ...
  remixethereum: {
    ...
    caption: "IDE para desarrollo en Ethereum",
    logo: { RemixEthereumLogo },
    category: 7,
  },
  metamask: {
    title: "Metamask",
    caption: "Wallet para interactuar con blockchain",
    logo: { MetamaskLogo },
    category: 7,
  },
