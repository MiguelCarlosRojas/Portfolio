...
export default function Experience() {
  ...
  return (
    <section id="experience" className={styles.experiences}>
      <SectionHead
        title="Experiencia"
        description="Cada proyecto es un desafío para combinar creatividad, tecnología y soluciones prácticas, trabajando en equipo para ofrecer experiencias digitales innovadoras, funcionales, eficientes y memorables."
        imageName="briefcase"
      />
            ...
            <div className={styles.itemRight}>
              ...
              >
                <span className={styles.detail}>
                  ...
                  <CaptionText text="Duración" size="small" weight="400" />
                  <h4>
                    {getDurationInMonths(
                ...
                <span className={styles.detail}>
                  ...
                  <CaptionText text="Empleo" size="small" weight="400" />
                ...
                <span className={styles.detail}>
                  ...
                  <CaptionText text="Modalidad" size="small" weight="400" />
